            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    FixId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    FixDescription = table.Column<string>(type: "nvarchar(200)", nullable: false),
                    BugId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_BugFixes", x => x.FixId);
                    table.ForeignKey(
                        name: "FK_BugFixes_Bugs_BugId",
                        column: x => x.BugId,
                        principalTable: "Bugs",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ReportId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Report = table.Column<string>(type: "nvarchar(200)", nullable: false),
                    BugId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
